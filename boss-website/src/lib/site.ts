...
export const SITE = {
  name: "Boss海投助手",
  // 蓝奏云插件下载链接
  LANZO_URL: "https://h2so4.lanzout.com/iHEVc3upgiwf",
  // 爱发卡购买额度链接
...
export const FEATURES = [
  ...
  },
  {
    ...
    color: "blue",
    title: "AI 针对性招呼语",
    desc: "接入 DeepSeek 大模型，结合你的简历与岗位 JD 自动生成定制打招呼话术，大幅提升 HR 回复率。",
    points: ["针对岗位匹配", "避免千篇一律", "定制化沟通"],
  },
  {
    no: "03",
    icon: "Gift",
...
export const PLANS = [
  {
    ...
    features: ["邀请好友双方各 10 次额度", "邀请次数无上限", "AI 智能招呼语", "基础投递功能"],
...
export const FAQS = [
  ...
  {
    q: "插件安全吗？会泄露我的简历和账号吗？",
    a: "插件仅在本地浏览器运行，不收集、不上传你的简历与账号信息。AI 招呼语通过加密接口调用，不留存个人数据。",
  },
  {
    q: "购买额度后多久到账？怎么使用？",
    a: "购买后会收到卡密，在插件「额度与充值」面板输入卡密即可秒到账。1 个卡密 = 100 次投递额度，可叠加充值。",
  },
  {
    q: "支持哪些浏览器和系统？",
